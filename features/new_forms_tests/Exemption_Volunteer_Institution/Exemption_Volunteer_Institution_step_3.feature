...
#    Then 5th Validate if went back to expected "email" form
  ...
  Scenario: EXCEPTVOLUNT_10 הזנת ערכים שגויים ב"בעלי תפקידים"
    ...
    Then from table "בעלי תפקידים" at row "1" validate "שם פרטי" error is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
    When from table "בעלי תפקידים" at row "1" write an invalid value "asdf" in "שם משפחה"
    Then from table "בעלי תפקידים" at row "1" validate "שם משפחה" error is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
    ...
    Then from table "בעלי תפקידים" at row "1" validate "דוא"ל" error is "שדה לא תקין"