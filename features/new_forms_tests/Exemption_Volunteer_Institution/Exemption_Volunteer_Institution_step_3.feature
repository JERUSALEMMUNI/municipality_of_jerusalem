...
#    Then 5th Validate if went back to expected "email" form
  ...
  Scenario: EXCEPTVOLUNT_10 הזנת ערכים שגויים ב"בעלי תפקידים"
    ...
    Then from table "בעלי תפקידים" at row "1" validate if "שם פרטי" value is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
    When from table "בעלי תפקידים" at row "1" write an invalid value "asdf" in "שם משפחה"
    Then from table "בעלי תפקידים" at row "1" validate if "שם משפחה" value is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
    ...
    Then from table "בעלי תפקידים" at row "1" validate if "מספר ת.ז." value is "מספר זהות לא תקין"
    ...
    Then from table "בעלי תפקידים" at row "1" validate if "דוא"ל" value is "שדה לא תקין"