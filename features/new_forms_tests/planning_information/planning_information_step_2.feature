...
#    And click on "המשך" button
  ...
  Scenario: TC_PLANNINGINFO_06 הזנת ערכים שגוים לשדות "פרטי הבקשה"
    ...
    Then validate "כתובת" error is "שפת הקלט לא תקינה"
    ...
    Then validate "כתובת" error is "ניתן להזין עד 50 תווים"
    When write an invalid value "234234234234" in "חלקות רצופות"
    Then validate "חלקות רצופות" error is "תווים X יש להזין מספר מעל/עד"
    When write an invalid value "234234234234234" in "חלקות בודדות"
    Then validate "חלקות בודדות" error is "תווים X יש להזין מספר מעל/עד"
    ...
    Then validate "נא מלא את את בקשתך, יש לציין גוש וחלקה ו/או תוכנית ומגרש ו/או כתובת ו/או קורדינאטות" error is "שפת קלט לא תקינה"
    When clear fields
