...
#    Then 5th Validate if went back to expected "email" form
    ...
    Then validate "שם חברת ההפקה" error is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
    When write an invalid value "876543" in "שם חברת ההפקה"
    Then validate "שם חברת ההפקה" error is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
    When fill "058-807868" as invalid value in "טלפון חברת ההפקה"
    Then validate "טלפון חברת ההפקה" error is "יש להשלים את הספרות החסרות"
    When write an invalid value "dddd" in "כתובת חברת ההפקה"
    Then validate "כתובת חברת ההפקה" error is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
    When write an invalid value "dddd" in "שם מתאם ההפקה"
    Then validate "שם מתאם ההפקה" error is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
    When write an invalid value "876543" in "שם מתאם ההפקה"
    Then validate "שם מתאם ההפקה" error is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
     When fill "058-807868" as invalid value in "טלפון מתאם ההפקה"
    Then validate "טלפון מתאם ההפקה" error is "יש להשלים את הספרות החסרות"
    ...
    Then validate "שם הגורם עבורו מתבצע הצילום" error is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
    ...
    Then validate "פירוט" error is "יש להזין אותיות בעברית בלבד ותווים מיוחדים " / () ' . , _ -"
