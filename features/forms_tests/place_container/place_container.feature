...
#  Scenario: general test for all fields
#    Given Navigate to "PlaceContainer" form
#    When choose "VALUE_NAME" from "סוג זהות"
#    When write a valid value "VALUE" in "מספר מזהה"
...
#    Given Navigate to "PlaceContainer" form
#    When choose "VALUE_NAME" from "סוג זהות"
#    When write an invalid value "VALUE" in "מספר מזהה"
#    When write a valid value "VALUE" in "שם פרטי"
#    When write a valid value "VALUE" in "שם משפחה"
#    When write a valid value "VALUE" in "מספר טלפון נייד"
#    When write a valid value "VALUE" in "אימייל"
...
#  Scenario: general test for all fields
#    Given Navigate to "PlaceContainer" form
#    When pick "OPTION_VALUE" from "רחוב הצבת המכולה"
#
#
#  Scenario: general test for all fields
#    Given Navigate to "PlaceContainer" form
...
#    When write a valid value "VALUE" in "מספר טלפון נייד"
#    When write a valid value "VALUE" in "אימייל"
#    When search for "SEARCH_VALUE" in "רחוב הצבת המכולה"
#    When write a valid value "VALUE" in "מספר בית"
#    When write a valid value "VALUE" in "מספר מכולה"
#    When pick date and time "VALUE" and "23:23" in "מתאריך:"
#    When pick date and time "VALUE" and "23:23" in "עד תאריך"
#    When pick "{option_value}" from "סוג חניה"
#    When write a valid value "VALUE" in "כתובת האתר לשפיכת הפסולת"
#    When click on "שמור" Button
#    When click on "המשך" Button
...
#    Then I compare "new_file1" with reference pdf file "PlaceContainer_empty_form"
  ...
  Scenario: TC_CONTAINER_12 - Enter a valid address
    ...
    And fill "052-4075877" as valid value in "מספר טלפון נייד"
    And write a valid value "@TEMP_EMAIL_ADDRESS" in "אימייל:"
    And write a valid value "א טברי" in "רחוב"
  ...
  Scenario: TC_CONTAINER_13 - Enter an invalid address
    ...
    And fill "052-4075877" as valid value in "מספר טלפון נייד"
    And write a valid value "@TEMP_EMAIL_ADDRESS" in "אימייל:"
    And write an invalid value "ww" in "רחוב"
    And write an invalid value "ww" in "מספר בית"
