Feature: Basic Test for ConfirmationForStructure Form Page
  ...
  Scenario: general test for all fields
    ...
    When I write "332796184" in "מספר ת.ז."
  ...
  Scenario: Empty id error msg
      Given I navigate to "ConfirmationForStructure" page
      When  I write "   " in "מספר ת.ז."
      Then  field "מספר ת.ז." has invalid value
      And  check if "מספר ת.ז." error is "empty_field_error"


   Scenario: using language id error msg
      Given I navigate to "ConfirmationForStructure" page
      When  I write "duus45a@" in "מספר ת.ז."
      Then  field "מספר ת.ז." has invalid value
      And  check if "מספר ת.ז." error is "enter_letters_error"
